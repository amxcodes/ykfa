...
const AboutUsPage = () => {
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-dark-900">
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-dark-900 to-dark-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div className={`animate-me opacity-0 translate-y-8 ${activeTab === 'mission' ? 'block' : 'hidden'}`} style={{ transition: 'all 0.8s ease-out' }}>
                <div className="backdrop-blur-lg bg-white/5 rounded-2xl border border-white/10 p-6 shadow-xl">
                  ...
                  <div className="space-y-4 text-gray-300">
                    ...
                    <div className="p-5 bg-amber-400/10 rounded-xl border border-amber-400/20 mt-6">
                      <h3 className="text-lg font-medium mb-2 text-white">Core Values</h3>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          <ChevronRight className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" />
                          <div>
                            <span className="font-medium text-white">Respect</span>
                            <p className="text-sm text-gray-400">For oneself, instructors, fellow students, and the art</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-2">
                          <ChevronRight className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" />
                          <div>
                            <span className="font-medium text-white">Discipline</span>
                            <p className="text-sm text-gray-400">Commitment to training and continuous improvement</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-2">
                          <ChevronRight className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" />
                          <div>
                            ...
                            <p className="text-sm text-gray-400">Honesty and ethical behavior in all situations</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-2">
                          <ChevronRight className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" />
                          <div>
                            <span className="font-medium text-white">Perseverance</span>
                            <p className="text-sm text-gray-400">The strength to overcome challenges and never give up</p>
                          </div>
                        </li>
                      </ul>
                    </div>
              ...
              <div className={`animate-me opacity-0 translate-y-8 ${activeTab === 'history' ? 'block' : 'hidden'}`} style={{ transition: 'all 0.8s ease-out' }}>
                <div className="backdrop-blur-lg bg-white/5 rounded-2xl border border-white/10 p-6 shadow-xl">
                  ...
                  <div className="space-y-6">
                    <div className="relative border-l-2 border-amber-400/30 pl-6 pb-6">
                      <div className="absolute top-0 left-0 w-4 h-4 -translate-x-1/2 bg-amber-400 rounded-full"></div>
                      <h3 className="text-xl font-medium text-white mb-2">The Beginning</h3>
                    ...
                    <div className="relative border-l-2 border-amber-400/30 pl-6 pb-6">
                      <div className="absolute top-0 left-0 w-4 h-4 -translate-x-1/2 bg-amber-400 rounded-full"></div>
                      <h3 className="text-xl font-medium text-white mb-2">Growth & Expansion</h3>
                      <p className="text-gray-300 mb-3">
                    ...
                    <div className="relative pl-6">
                      <div className="absolute top-0 left-0 w-4 h-4 -translate-x-1/2 bg-amber-400 rounded-full"></div>
                      <h3 className="text-xl font-medium text-white mb-2">YKFA Today</h3>
                      <p className="text-gray-300 mb-3">
                ...
                <div className="backdrop-blur-lg bg-white/5 rounded-2xl border border-white/10 p-6 shadow-xl">
                  ...
                  <div className="space-y-5 text-gray-300">
                    ...
                    <blockquote className="p-4 border-l-4 border-amber-400 bg-white/5 rounded-r-lg italic mt-6">
                      <p>"Martial arts is not about fighting others, but about conquering yourself. The greatest victory is self-improvement."</p>
              ...
              {/* Contact info card */}
              <div className="backdrop-blur-lg bg-white/5 rounded-2xl border border-white/10 p-6 shadow-xl animate-me opacity-0 translate-y-8" style={{ transition: 'all 0.8s ease-out' }}>
